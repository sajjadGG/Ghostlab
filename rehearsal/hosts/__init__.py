...
def build_hosts(spec, spec_path, timeout: float = 30.0) -> list[HostAdapter]:
    ...
    protocol suites are always executable.
    """
    ...
    for host in spec.hosts or []:
        ...
        if kind == "direct-mcp":
            ...
            adapters.append(RunnerHost(host_id, kind, host, spec_path))
